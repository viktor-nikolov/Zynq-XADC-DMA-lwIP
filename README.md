...
E.g. to have a sampling rate of 100 ksps, set the Clocking Wizard, which feeds the XADC Wizard input clock, to 101.4&nbsp;MHz and set the divider ratio to 39 (by calling [XSysMon_SetAdcClkDivisor](https://github.com/Xilinx/embeddedsw/blob/5688620af40994a0012ef5db3c873e1de3f20e9f/XilinxProcessorIPLib/drivers/sysmon/src/xsysmon.c#L1089)).&nbsp;&nbsp;&nbsp;$`\frac{101400}{39} = 2600`$&nbsp;&nbsp;&nbsp;&nbsp;$`\frac{2600}{26} = 100 \mskip3mu ksps`$
